			...
			<div id="logo">
				<table width="100%" cellspacing="0" cellpadding="0" border="0">
					...
					<td align="right" valign="top">			
						...
						<tr><td style="color: #FFF; text-align: right"><a href="http://www.mtgox.com" target="_blank">MtGox (USD):</a></td><td style="color: #FFF">$<?php print $settings->getsetting('mtgoxlast'); ?></td></tr>
